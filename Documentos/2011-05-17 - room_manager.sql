...
--
-- Servidor: localhost
-- Tempo de Geração: Mai 17, 2011 as 11:35 PM
...
--
-- Estrutura da tabela `course_subject_crowd`
--

CREATE TABLE IF NOT EXISTS `course_subject_crowd` (
  `cosc_cd_key` int(11) NOT NULL AUTO_INCREMENT,
  `cour_cd_key` int(11) NOT NULL,
  `subj_cd_key` int(11) NOT NULL,
  `crow_cd_key` int(11) NOT NULL,
  `cosc_nb_slot` int(11) NOT NULL,
  PRIMARY KEY (`cosc_cd_key`),
...
--
-- Extraindo dados da tabela `course_subject_crowd`
--

INSERT INTO `course_subject_crowd` (`cosc_cd_key`, `cour_cd_key`, `subj_cd_key`, `crow_cd_key`, `cosc_nb_slot`) VALUES
(2, 1, 1, 3, 12),
(3, 1, 1, 4, 33);
...
INSERT INTO `crowd` (`crow_cd_key`, `teac_cd_key`, `crow_nm_name`, `crow_nb_module`) VALUES
(3, 1, 'A2', 45),
(4, 2, 'A3', 34);
...
INSERT INTO `room` (`room_cd_key`, `buil_cd_key`, `room_nm_number`) VALUES
(2, 1, '230');
...
(1, 'Administrador', '', 'admin@admin.com', 'admin', 'sha1', 'dd994942d883ea20c746c039752205ea', 'ab7b775c8c0f35a30e4afb8b03e570bbbf238cf2', 1, 1, '2011-05-17 21:32:47', '2011-04-19 02:10:29', '2011-05-17 21:32:47'),
...
INSERT INTO `subject` (`subj_cd_key`, `subj_nm_code`, `subj_nm_name`) VALUES
(1, '', 'APA');
...
--
-- Restrições para a tabela `course_subject_crowd`
--
ALTER TABLE `course_subject_crowd`
  ADD CONSTRAINT `course_subject_crowd_ibfk_3` FOREIGN KEY (`crow_cd_key`) REFERENCES `crowd` (`crow_cd_key`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `course_subject_crowd_ibfk_1` FOREIGN KEY (`cour_cd_key`) REFERENCES `course` (`cour_cd_key`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `course_subject_crowd_ibfk_2` FOREIGN KEY (`subj_cd_key`) REFERENCES `subject` (`subj_cd_key`) ON DELETE CASCADE ON UPDATE CASCADE;
